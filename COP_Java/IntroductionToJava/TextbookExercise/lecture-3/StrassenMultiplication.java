public class StrassenMultiplication {
    public static int[][] multiplyMatrices(int[][] A, int[][] B) {
		...
		if (n == 1) {
			...
			int[][] P1 = multiplyMatrices(A11, subtractMatrix(B12, B22));
			int[][] P2 = multiplyMatrices(addMatrix(A11, A12), B22);
			int[][] P3 = multiplyMatrices(addMatrix(A21, A22), B11);
			int[][] P4 = multiplyMatrices(A22, subtractMatrix(B21, B11));
			int[][] P5 = multiplyMatrices(addMatrix(A11, A22), addMatrix(B11, B22));
			int[][] P6 = multiplyMatrices(subtractMatrix(A12, A22), addMatrix(B21, B22));
			int[][] P7 = multiplyMatrices(subtractMatrix(A11, A21), addMatrix(B11, B12));
